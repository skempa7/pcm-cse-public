...
- Exam guide is a rehearsal aid. Its example documentation is conditional, not a finding obtained from clicking through the lesson. Written walkthroughs provide an access-checked landscape print preview. The September 13 print edition includes current patient images, full vital labels, a brief guide to the current workspace, and recall explanations starting on a separate page. Use Learn → choose a case/path → Print walkthrough → Print / Save PDF.
