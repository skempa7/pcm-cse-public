...
const ready=(async()=>{
 ...
 const response=await fetch(new URL('./engine.zip?v=voice-identity-1',import.meta.url),{cache:'no-store'});if(!response.ok)throw Error('The browser engine download failed. Reload to try again.');
