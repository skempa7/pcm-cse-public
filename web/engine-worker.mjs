...
const ready=(async()=>{
 ...
 const response=await fetch(new URL('./engine.zip?v=8e66eab69b',import.meta.url),{cache:'no-store'});if(!response.ok)throw Error('The browser engine download failed. Reload to try again.');
